...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('laravel_dropzone.index', compact('posts'));
    }
    ...
    {
        return view('laravel_dropzone.create');
    }
    ...
    public function show(Post $post)
    {
        ...
        return view('laravel_dropzone.show', compact('post'));
    }
    ...
    {
        $post->load('media'); //Make sure media is included
        return view('laravel_dropzone.edit', compact('post'));
    }
